      ...
      try {
        ...
        if (data.user) {
          setProfileData({
            ...
            kontrakanNo: data.user.kontrakanNo || "",
            kontrakanAlamat: data.user.kontrakanAlamat || "",
            noKTP: data.user.noKTP || "",
            pekerjaan: data.user.pekerjaan || "",
            darurat: data.user.darurat || { nama: "", hubungan: "", noTelp: "" },
            role: data.user.role || "penyewa",
    ...
    try {
      const res = await fetch("/api/sync-user", {
        ...
        body: JSON.stringify({
          ...
          kontrakanNo: tempData.kontrakanNo,
          kontrakanAlamat: tempData.kontrakanAlamat,
          noKTP: tempData.noKTP,
          pekerjaan: tempData.pekerjaan,
          darurat: tempData.darurat,
          role: "penyewa",
        ...
        <section className="container mx-auto px-4 py-10">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-slate-400">Kelola informasi pribadi Anda sebagai penyewa kontrakan</p>
            </div>
              ...
              <div className="col-span-1">
                <div className="bg-slate-800/60 backdrop-blur-sm rounded-xl shadow-lg border border-slate-700/50 overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-emerald-900/40 to-teal-900/40 p-6 text-center relative">
                    ...
                    <h2 className="text-xl font-bold mb-1 text-emerald-300">{profileData.nama || "Nama Penyewa"}</h2>
                    <p className="text-emerald-200">Penyewa</p>
                  </div>
                  {/* Informasi Kontrakan */}
                  <div className="p-5 border-b border-slate-700/50">
                    ...
                    <div className="space-y-3 text-sm">
                      <div>
                        <div className="text-slate-400 mb-1">No. Kontrakan</div>
                        <div className="font-medium text-slate-100">{profileData.kontrakanNo || "-"}</div>
                      </div>
                      <div>
                        <div className="text-slate-400 mb-1">Alamat Kontrakan</div>
                        <div className="font-medium text-slate-100">{profileData.kontrakanAlamat || "-"}</div>
                      </div>
                      <div>
